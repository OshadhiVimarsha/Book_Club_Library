          ...
          {books.length === 0 ? (
              ...
              books.map((book) => (
                  <tr key={book._id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{book.description}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{book.language}</td>
